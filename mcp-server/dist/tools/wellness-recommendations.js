 ...
 */
export async function generateWellnessRecommendations(input) {
...
function generateImmediateRecommendations(input, timeAvailable, activityLevel) {
...
function generateShortTermRecommendations(input, timeAvailable, activityLevel, environment) {
    const recommendations = [];
...
function generateLongTermRecommendations(input, activityLevel) {
    const recommendations = [];
...
//# sourceMappingURL=wellness-recommendations.js.map