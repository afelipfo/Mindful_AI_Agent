...
} from "./tools/wellness-recommendations.js";
import {
  generateUserInsights,
  UserInsightsInputSchema,
} from "./tools/user-insights.js";
...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Analyzes historical mood data to identify patterns, trends, and triggers. Generates personalized insights and recommendations based on mood history over time.",
    inputSchema: {
      type: "object",
      properties: {
        userId: {
